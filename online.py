...
if st.sidebar.button("🚪 ออกจากระบบ (Logout)"):
    ...
    st.rerun()
st.sidebar.caption("Off Fitz Claim Management System v3.2")
                    ...
                    try:
                        ...
                        if defect_images:
                            for img_file in defect_images:
                                ...
                                # 🛡️ ปลอมตัวเป็น Google Chrome เพื่อหลบ Firewall ของ Plesk
                                fake_headers = {
                                    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36',
                                    'Accept': 'application/json'
                                }
                                
                                response = requests.post(UPLOAD_URL, files=files, headers=fake_headers)
                                ...
                                try:
                                    ...
                                    raise Exception("ระบบอัปโหลดรูปภาพถูกเซิร์ฟเวอร์ปฏิเสธ")
